...
<body class="is-preload">
	...
	<script src="assets/js/breakpoints.min.js?v=<?= filemtime('assets/js/breakpoints.min.js') ?>"></script>
	<script src="assets/js/util.js?v=<?= filemtime('assets/js/util.js') ?>"></script>
